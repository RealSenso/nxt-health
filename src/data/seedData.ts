...
const BASE_SEED_USERS: User[] = [
  ...
  {
    id: 'user-member-2',
    email: 'priya@neurotrack.health',
    name: 'Priya Raman (Founder, NeuroTrack)',
    role: 'member',
    is_member: true,
    password: 'demo1234',
  ...
  {
    id: 'user-member-3',
    email: 'james@cardiaiq.com',
    name: 'James Okafor (Founder, CardiaIQ)',
    role: 'member',
    is_member: true,
    password: 'demo1234',
    location: 'London, UK',
  ...
  {
    id: 'user-member-4',
    email: 'mei@resptech.io',
    name: 'Mei Tanaka (Founder, RespTech)',
    role: 'member',
    is_member: false,
    password: 'demo1234',
  ...
  {
    id: 'user-member-5',
    email: 'diego@oncoscan.health',
    name: 'Diego Fernandez (Founder, OncoScan)',
    role: 'member',
    is_member: true,
    password: 'demo1234',
    location: 'Austin, TX',
  ...
  {
    id: 'user-member-6',
    email: 'amara@vitalsense.co',
    name: 'Amara Okonkwo (Founder, VitalSense)',
    role: 'member',
    is_member: false,
    password: 'demo1234',
    location: 'Boston, MA',
